...
<svg viewBox="0 0 460 180" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:460px;">
<text x="230" y="14" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">Arquitectura de OWASP Juice Shop</text>
<!-- Frontend -->
<rect x="10" y="24" width="440" height="50" rx="6" fill="#3b82f6"/><text x="230" y="40" text-anchor="middle" fill="white" font-size="10" font-weight="bold">FRONTEND — Angular</text>
<rect x="20" y="48" width="120" height="20" rx="4" fill="#2563eb"/><text x="80" y="62" text-anchor="middle" fill="white" font-size="8">Login</text>
<rect x="170" y="48" width="120" height="20" rx="4" fill="#2563eb"/><text x="230" y="62" text-anchor="middle" fill="white" font-size="8">Basket</text>
<rect x="320" y="48" width="120" height="20" rx="4" fill="#2563eb"/><text x="380" y="62" text-anchor="middle" fill="white" font-size="8">Admin Panel</text>
<!-- Arrow -->
<line x1="230" y1="74" x2="230" y2="86" stroke="#94a3b8" stroke-width="2"/>
<text x="240" y="84" fill="#64748b" font-size="8">HTTP/REST</text>
<!-- Backend -->
<rect x="10" y="90" width="440" height="50" rx="6" fill="#8b5cf6"/><text x="230" y="106" text-anchor="middle" fill="white" font-size="10" font-weight="bold">BACKEND — Express.js</text>
<rect x="20" y="114" width="120" height="20" rx="4" fill="#7c3aed"/><text x="80" y="128" text-anchor="middle" fill="white" font-size="8">Auth Routes</text>
<rect x="170" y="114" width="120" height="20" rx="4" fill="#7c3aed"/><text x="230" y="128" text-anchor="middle" fill="white" font-size="8">API Routes</text>
<rect x="320" y="114" width="120" height="20" rx="4" fill="#7c3aed"/><text x="380" y="128" text-anchor="middle" fill="white" font-size="8">File Server</text>
<!-- Arrow -->
<line x1="230" y1="140" x2="230" y2="152" stroke="#94a3b8" stroke-width="2"/>
<text x="240" y="150" fill="#64748b" font-size="8">SQL</text>
<!-- Database -->
<rect x="10" y="155" width="440" height="28" rx="6" fill="#10b981"/><text x="230" y="173" text-anchor="middle" fill="white" font-size="9" font-weight="bold">DATABASE — SQLite (Users, Products, BasketItems, Orders, Challenges)</text>
</svg>
</div>
...
<div class="mermaid-diagram" style="background: #1e293b; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #334155;">
<div style="color: #94a3b8; font-size: 0.85em; margin-bottom: 10px; font-family: monospace;">Figura 4: Burp Suite — Request SQLi y respuesta con JWT de admin</div>
<svg viewBox="0 0 600 120" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;">
<rect x="10" y="10" width="110" height="45" rx="6" fill="#3b82f6"/><text x="65" y="30" text-anchor="middle" fill="white" font-size="11" font-weight="bold">POST</text><text x="65" y="45" text-anchor="middle" fill="#dbeafe" font-size="9">/rest/user/login</text>
<polygon points="120,32 170,32 165,27 170,37" fill="#94a3b8"/>
<rect x="170" y="10" width="110" height="45" rx="6" fill="#3b82f6"/><text x="225" y="27" text-anchor="middle" fill="white" font-size="10" font-weight="bold">Content-Type</text><text x="225" y="42" text-anchor="middle" fill="#dbeafe" font-size="9">application/json</text>
<polygon points="280,32 320,32 315,27 320,37" fill="#94a3b8"/>
<rect x="320" y="10" width="160" height="45" rx="6" fill="#3b82f6"/><text x="400" y="27" text-anchor="middle" fill="white" font-size="10" font-weight="bold">Body (SQLi Payload)</text><text x="400" y="42" text-anchor="middle" fill="#dbeafe" font-family="monospace" font-size="8">{"email":"' OR 1=1--"}</text>
<polygon points="480,32 510,32 505,27 510,37" fill="#94a3b8"/>
<rect x="10" y="70" width="110" height="40" rx="6" fill="#10b981"/><text x="65" y="87" text-anchor="middle" fill="white" font-size="11" font-weight="bold">200 OK</text><text x="65" y="100" text-anchor="middle" fill="#d1fae5" font-size="9">Response</text>
<polygon points="120,90 170,90 165,85 170,95" fill="#94a3b8"/>
<rect x="170" y="70" width="410" height="40" rx="6" fill="#10b981"/><text x="375" y="87" text-anchor="middle" fill="white" font-size="10" font-weight="bold">{"authentication":{"token":"eyJ...","umail":"admin@juice-sh.op"}}</text>
</svg>
</div>
...
<text x="230" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Flujo DOM XSS — Ataque en el Cliente</text>
<!-- Step 1 -->
<rect x="10" y="24" width="210" height="24" rx="4" fill="#ef4444"/><text x="115" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">1. URL maliciosa con payload</text>
<!-- Arrow -->
<line x1="220" y1="36" x2="235" y2="36" stroke="#94a3b8" stroke-width="1.5"/>
<!-- Step 2 -->
<rect x="235" y="24" width="215" height="24" rx="4" fill="#f59e0b"/><text x="342" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">2. JS lee URL sin sanitizar</text>
<!-- Arrow down -->
<line x1="342" y1="48" x2="342" y2="60" stroke="#94a3b8" stroke-width="1.5"/>
<!-- Step 3 -->
<rect x="120" y="62" width="220" height="24" rx="4" fill="#8b5cf6"/><text x="230" y="78" text-anchor="middle" fill="white" font-size="8" font-weight="bold">3. innerHTML = query (SIN escape)</text>
<!-- Arrow down -->
<line x1="230" y1="86" x2="230" y2="98" stroke="#94a3b8" stroke-width="1.5"/>
<!-- Step 4 -->
<rect x="10" y="100" width="440" height="30" rx="4" fill="#1e293b"/><text x="230" y="114" text-anchor="middle" fill="#fca5a5" font-size="8" font-weight="bold">4. Browser ejecuta script → Cookie stealing, session hijacking, keylogging</text>
<text x="230" y="128" text-anchor="middle" fill="#64748b" font-size="7">⚠️ El servidor NUNCA ve el payload — todo ocurre en el cliente</text>
</svg>
</div>
...
<div class="mermaid-diagram" style="background: #1e293b; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #334155;">
<div style="color: #94a3b8; font-size: 0.85em; margin-bottom: 10px; font-family: monospace;">Figura 5: DOM XSS — Flujo de sanitización desactivada en Angular</div>
<svg viewBox="0 0 600 260" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;">
<text x="300" y="20" text-anchor="middle" fill="#e2e8f0" font-size="14" font-weight="bold">DOM XSS — Sanitization Bypass Flow</text>
<rect x="150" y="35" width="300" height="35" rx="6" fill="#ef4444"/><text x="300" y="57" text-anchor="middle" fill="white" font-size="11" font-weight="bold">User Input: &lt;iframe src="javascript:alert('xss')"&gt;</text>
<polygon points="300,70 300,90 295,85 305,85" fill="#94a3b8"/>
<rect x="150" y="95" width="300" height="35" rx="6" fill="#f59e0b"/><text x="300" y="117" text-anchor="middle" fill="white" font-size="11" font-weight="bold">Angular Search Component</text>
<polygon points="300,130 300,150 295,145 305,145" fill="#94a3b8"/>
<rect x="150" y="155" width="300" height="35" rx="6" fill="#f59e0b"/><text x="300" y="177" text-anchor="middle" fill="white" font-size="11" font-weight="bold">bypassSecurityTrustHtml() → DISABLED</text>
<polygon points="300,190 300,210 295,205 305,205" fill="#94a3b8"/>
<rect x="150" y="215" width="140" height="35" rx="6" fill="#f59e0b"/><text x="220" y="237" text-anchor="middle" fill="white" font-size="11">Render in DOM</text>
<polygon points="290,232 330,232 325,227 330,237" fill="#94a3b8"/>
<rect x="330" y="215" width="120" height="35" rx="6" fill="#10b981"/><text x="390" y="237" text-anchor="middle" fill="white" font-size="11">&lt;iframe&gt; executes</text>
<polygon points="390,250 390,270 385,265 395,265" fill="#94a3b8"/>
<rect x="270" y="275" width="240" height="35" rx="6" fill="#10b981"/><text x="390" y="297" text-anchor="middle" fill="white" font-size="11" font-weight="bold">alert('xss') popup ✓</text>
</svg>
</div>
...
<div class="mermaid-diagram" style="background: #1e293b; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #334155;">
<div style="color: #94a3b8; font-size: 0.85em; margin-bottom: 10px; font-family: monospace;">Figura 6: Burp Suite — Interceptación de petición con payload XSS</div>
<svg viewBox="0 0 600 280" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;">
<text x="300" y="20" text-anchor="middle" fill="#e2e8f0" font-size="14" font-weight="bold">Burp Suite — XSS Interception Sequence</text>
<rect x="30" y="35" width="80" height="25" rx="4" fill="#ef4444"/><text x="70" y="52" text-anchor="middle" fill="white" font-size="10">User</text>
<rect x="180" y="35" width="80" height="25" rx="4" fill="#f59e0b"/><text x="220" y="52" text-anchor="middle" fill="white" font-size="10">Burp Proxy</text>
<rect x="350" y="35" width="80" height="25" rx="4" fill="#10b981"/><text x="390" y="52" text-anchor="middle" fill="white" font-size="10">Server</text>
<rect x="500" y="35" width="80" height="25" rx="4" fill="#3b82f6"/><text x="540" y="52" text-anchor="middle" fill="white" font-size="10">Browser DOM</text>
<line x1="70" y1="60" x2="70" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="220" y1="60" x2="220" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="390" y1="60" x2="390" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="540" y1="60" x2="540" y2="270" stroke="#64748b" stroke-width="1"/>
<polygon points="70,85 220,85 215,80 220,90" fill="#94a3b8"/><text x="145" y="80" text-anchor="middle" fill="#e2e8f0" font-size="9">Search: &lt;iframe src="javascript:alert(1)"&gt;</text>
<polygon points="220,110 390,110 385,105 390,115" fill="#94a3b8"/><text x="305" y="105" text-anchor="middle" fill="#e2e8f0" font-size="9">GET /rest/products/search?q=&lt;iframe...&gt;</text>
<polygon points="390,135 220,135 225,130 220,140" fill="#94a3b8" stroke-dasharray="4,2"/><text x="305" y="130" text-anchor="middle" fill="#e2e8f0" font-size="9">200 OK (JSON response)</text>
<polygon points="220,160 70,160 75,155 70,165" fill="#94a3b8" stroke-dasharray="4,2"/><text x="145" y="155" text-anchor="middle" fill="#e2e8f0" font-size="9">Forward response</text>
<polygon points="70,185 540,185 535,180 540,190" fill="#94a3b8"/><text x="305" y="180" text-anchor="middle" fill="#e2e8f0" font-size="9">Angular renders unsanitized HTML</text>
<polygon points="540,210 70,210 75,205 70,215" fill="#94a3b8" stroke-dasharray="4,2"/><text x="305" y="205" text-anchor="middle" fill="#e2e8f0" font-size="9">alert(1) executes in browser</text>
<rect x="120" y="235" width="360" height="30" rx="6" fill="#7f1d1d" stroke="#ef4444"/><text x="300" y="255" text-anchor="middle" fill="#fca5a5" font-size="11">⚠ XSS executes in victim's browser context</text>
</svg>
</div>
...
<text x="230" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Flujo Reflected XSS — Payload pasa por el servidor</text>
<rect x="10" y="24" width="130" height="24" rx="4" fill="#ef4444"/><text x="75" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">1. URL maliciosa</text>
<polygon points="140,36 155,36 152,33 155,39" fill="#94a3b8"/>
<rect x="155" y="24" width="130" height="24" rx="4" fill="#f59e0b"/><text x="220" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">2. Víctima hace clic</text>
<polygon points="285,36 300,36 297,33 300,39" fill="#94a3b8"/>
<rect x="300" y="24" width="150" height="24" rx="4" fill="#8b5cf6"/><text x="375" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">3. Servidor refleja payload</text>
<line x1="375" y1="48" x2="375" y2="60" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="230" y="62" width="220" height="24" rx="4" fill="#3b82f6"/><text x="340" y="78" text-anchor="middle" fill="white" font-size="8" font-weight="bold">4. Respuesta HTML inyectada</text>
<line x1="340" y1="86" x2="340" y2="98" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="10" y="100" width="440" height="20" rx="4" fill="#1e293b"/><text x="230" y="114" text-anchor="middle" fill="#fca5a5" font-size="8">5. Browser ejecuta script → Cookie stealing, session hijacking</text>
</svg>
</div>
...
<div class="mermaid-diagram" style="background: #1e293b; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #334155;">
<div style="color: #94a3b8; font-size: 0.85em; margin-bottom: 10px; font-family: monospace;">Figura 7: Reflected XSS — URL maliciosa con payload en parámetro</div>
<svg viewBox="0 0 600 140" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;">
<text x="300" y="20" text-anchor="middle" fill="#e2e8f0" font-size="14" font-weight="bold">Reflected XSS — Malicious URL Flow</text>
<rect x="10" y="35" width="100" height="35" rx="6" fill="#ef4444"/><text x="60" y="57" text-anchor="middle" fill="white" font-size="11" font-weight="bold">Malicious URL</text>
<polygon points="110,52 140,52 135,47 140,57" fill="#94a3b8"/>
<rect x="140" y="35" width="120" height="35" rx="6" fill="#ef4444"/><text x="200" y="50" text-anchor="middle" fill="white" font-size="9" font-weight="bold">localhost:3000/</text><text x="200" y="62" text-anchor="middle" fill="#fca5a5" font-size="9">#/track-result</text>
<polygon points="260,52 290,52 285,47 290,57" fill="#94a3b8"/>
<rect x="290" y="35" width="120" height="35" rx="6" fill="#ef4444"/><text x="350" y="50" text-anchor="middle" fill="white" font-size="9" font-weight="bold">?id=&lt;iframe</text><text x="350" y="62" text-anchor="middle" fill="#fca5a5" font-size="9">src="javascript:..."&gt;</text>
<polygon points="410,52 440,52 435,47 440,57" fill="#94a3b8"/>
<rect x="440" y="35" width="150" height="35" rx="6" fill="#f59e0b"/><text x="515" y="57" text-anchor="middle" fill="white" font-size="10">Server reflects 'id'</text>
<polygon points="515,70 515,95 510,90 520,90" fill="#94a3b8"/>
<rect x="440" y="100" width="150" height="35" rx="6" fill="#10b981"/><text x="515" y="122" text-anchor="middle" fill="white" font-size="10">Browser renders HTML</text>
<polygon points="440,117 380,117 385,112 380,122" fill="#94a3b8"/>
<rect x="260" y="100" width="120" height="35" rx="6" fill="#10b981"/><text x="320" y="122" text-anchor="middle" fill="white" font-size="11" font-weight="bold">XSS executes</text>
<polygon points="260,117 200,117 205,112 200,122" fill="#94a3b8"/>
<rect x="80" y="100" width="120" height="35" rx="6" fill="#10b981"/><text x="140" y="122" text-anchor="middle" fill="white" font-size="11">Payload delivered</text>
</svg>
</div>
...
<svg viewBox="0 0 460 110" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:460px;">
<text x="230" y="14" text-anchor="middle" fill="#1e293b" font-size="11" font-weight="bold">Estructura JWT — JSON Web Token</text>
<!-- Token -->
<rect x="10" y="24" width="140" height="30" rx="4" fill="#3b82f6"/><text x="80" y="44" text-anchor="middle" fill="white" font-size="9" font-weight="bold">HEADER</text>
<text x="80" y="68" text-anchor="middle" fill="#64748b" font-size="7">{"alg":"HS256","typ":"JWT"}</text>
<text x="155" y="44" text-anchor="middle" fill="#94a3b8" font-size="12">.</text>
<rect x="160" y="24" width="140" height="30" rx="4" fill="#8b5cf6"/><text x="230" y="44" text-anchor="middle" fill="white" font-size="9" font-weight="bold">PAYLOAD</text>
<text x="230" y="68" text-anchor="middle" fill="#64748b" font-size="7">{"data":"admin@...","iat":...}</text>
<text x="305" y="44" text-anchor="middle" fill="#94a3b8" font-size="12">.</text>
<rect x="310" y="24" width="140" height="30" rx="4" fill="#10b981"/><text x="380" y="44" text-anchor="middle" fill="white" font-size="9" font-weight="bold">SIGNATURE</text>
<text x="380" y="68" text-anchor="middle" fill="#64748b" font-size="7">HMAC-SHA256(header.payload, key)</text>
<!-- Attack note -->
<rect x="10" y="84" width="440" height="22" rx="4" fill="#fef2f2" stroke="#ef4444" stroke-width="1"/>
<text x="230" y="99" text-anchor="middle" fill="#dc2626" font-size="8" font-weight="bold">Ataque alg:none → Cambiar header a {"alg":"none"} + eliminar signature = token válido sin firma</text>
</svg>
</div>
...
<div class="compact-diagram" style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 18px;margin:14px 0;">
<svg viewBox="0 0 460 110" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:460px;">
<text x="230" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Flujo IDOR — Insecure Direct Object Reference</text>
<rect x="10" y="24" width="210" height="24" rx="4" fill="#3b82f6"/><text x="115" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">1. GET /basket/5 → ✅ OK (propio)</text>
<line x1="220" y1="36" x2="235" y2="36" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="235" y="24" width="215" height="24" rx="4" fill="#ef4444"/><text x="342" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">2. Auth OK pero NO verifica ownership</text>
<line x1="342" y1="48" x2="342" y2="60" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="100" y="62" width="260" height="24" rx="4" fill="#f59e0b"/><text x="230" y="78" text-anchor="middle" fill="white" font-size="8" font-weight="bold">3. Attacker cambia ID → /basket/1, /basket/2...</text>
<line x1="230" y1="86" x2="230" y2="96" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="10" y="98" width="440" height="18" rx="4" fill="#1e293b"/><text x="230" y="111" text-anchor="middle" fill="#fca5a5" font-size="8">4. Attacker ve TODOS los baskets → Data breach completo</text>
</svg>
</div>
...
<div class="compact-diagram" style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 18px;margin:14px 0;">
<svg viewBox="0 0 460 110" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:460px;">
<text x="230" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Flujo Directory Traversal — Escapar del directorio permitido</text>
<rect x="10" y="24" width="210" height="24" rx="4" fill="#3b82f6"/><text x="115" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">1. GET /ftp/&lt;filename&gt;</text>
<line x1="220" y1="36" x2="235" y2="36" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="235" y="24" width="215" height="24" rx="4" fill="#ef4444"/><text x="342" y="40" text-anchor="middle" fill="white" font-size="8" font-weight="bold">2. ../../../etc/passwd</text>
<line x1="342" y1="48" x2="342" y2="60" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="100" y="62" width="260" height="24" rx="4" fill="#f59e0b"/><text x="230" y="78" text-anchor="middle" fill="white" font-size="8" font-weight="bold">3. /app/ftp/../../../etc/passwd = /etc/passwd</text>
<line x1="230" y1="86" x2="230" y2="96" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="10" y="98" width="440" height="18" rx="4" fill="#1e293b"/><text x="230" y="111" text-anchor="middle" fill="#fca5a5" font-size="8">4. Sin validación de path → archivo del SO expuesto</text>
</svg>
</div>
...
<div class="compact-diagram" style="background:#fef2f2;border:1px solid #fecaca;border-radius:8px;padding:14px 18px;margin:14px 0;">
<svg viewBox="0 0 460 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:460px;">
<text x="230" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Flujo Stored XSS via API — Payload almacenado permanentemente</text>
<!-- Phase 1 -->
<rect x="10" y="22" width="210" height="20" rx="4" fill="#ef4444"/><text x="115" y="36" text-anchor="middle" fill="white" font-size="8" font-weight="bold">FASE 1: INYECCIÓN</text>
<rect x="10" y="44" width="210" height="20" rx="4" fill="#3b82f6"/><text x="115" y="58" text-anchor="middle" fill="white" font-size="7">POST /api/Feedback → BD sin sanitizar</text>
<!-- Arrow -->
<line x1="220" y1="54" x2="235" y2="54" stroke="#94a3b8" stroke-width="1.5"/>
<!-- Phase 2 -->
<rect x="235" y="22" width="215" height="20" rx="4" fill="#8b5cf6"/><text x="342" y="36" text-anchor="middle" fill="white" font-size="8" font-weight="bold">FASE 2: EJECUCIÓN</text>
<rect x="235" y="44" width="215" height="20" rx="4" fill="#10b981"/><text x="342" y="58" text-anchor="middle" fill="white" font-size="7">GET feedback → render sin encoding</text>
<!-- Arrow down -->
<line x1="342" y1="64" x2="342" y2="76" stroke="#94a3b8" stroke-width="1.5"/>
<!-- Result -->
<rect x="100" y="78" width="260" height="24" rx="4" fill="#f59e0b"/><text x="230" y="94" text-anchor="middle" fill="white" font-size="8" font-weight="bold">Browser ejecuta script automáticamente</text>
<line x1="230" y1="102" x2="230" y2="112" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="10" y="114" width="440" height="18" rx="4" fill="#1e293b"/><text x="230" y="127" text-anchor="middle" fill="#fca5a5" font-size="8">⚠️ Cada usuario que visita la página ejecuta el script — sin necesidad de clic especial</text>
</svg>
</div>
...
<div class="mermaid-diagram" style="background: #1e293b; border-radius: 12px; padding: 20px; margin: 20px 0; border: 1px solid #334155;">
<div style="color: #94a3b8; font-size: 0.85em; margin-bottom: 10px; font-family: monospace;">Figura 12: Stored XSS — Inyección via API y ejecución en panel admin</div>
<svg viewBox="0 0 600 280" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;">
<text x="300" y="20" text-anchor="middle" fill="#e2e8f0" font-size="14" font-weight="bold">Stored XSS — API Injection Sequence</text>
<rect x="20" y="35" width="90" height="25" rx="4" fill="#ef4444"/><text x="65" y="52" text-anchor="middle" fill="white" font-size="10">Attacker</text>
<rect x="170" y="35" width="90" height="25" rx="4" fill="#f59e0b"/><text x="215" y="52" text-anchor="middle" fill="white" font-size="10">/api/Feedback</text>
<rect x="340" y="35" width="90" height="25" rx="4" fill="#10b981"/><text x="385" y="52" text-anchor="middle" fill="white" font-size="10">Database</text>
<rect x="490" y="35" width="90" height="25" rx="4" fill="#3b82f6"/><text x="535" y="52" text-anchor="middle" fill="white" font-size="10">Admin Panel</text>
<line x1="65" y1="60" x2="65" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="215" y1="60" x2="215" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="385" y1="60" x2="385" y2="270" stroke="#64748b" stroke-width="1"/>
<line x1="535" y1="60" x2="535" y2="270" stroke="#64748b" stroke-width="1"/>
<polygon points="65,85 215,85 210,80 215,90" fill="#94a3b8"/><text x="140" y="80" text-anchor="middle" fill="#e2e8f0" font-size="9">POST {"comment":"&lt;script&gt;alert(1)&lt;/script&gt;"}</text>
<polygon points="215,110 385,110 380,105 385,115" fill="#94a3b8"/><text x="300" y="105" text-anchor="middle" fill="#e2e8f0" font-size="9">INSERT INTO Feedback (no sanitization)</text>
<polygon points="385,135 215,135 220,130 215,140" fill="#94a3b8" stroke-dasharray="4,2"/><text x="300" y="130" text-anchor="middle" fill="#e2e8f0" font-size="9">201 Created</text>
<rect x="140" y="155" width="320" height="30" rx="6" fill="#7f1d1d" stroke="#ef4444"/><text x="300" y="175" text-anchor="middle" fill="#fca5a5" font-size="11">⚠ Malicious payload stored in database</text>
<polygon points="535,205 385,205 390,200 385,210" fill="#94a3b8"/><text x="460" y="200" text-anchor="middle" fill="#e2e8f0" font-size="9">SELECT * FROM Feedback</text>
<polygon points="385,230 535,230 530,225 535,235" fill="#94a3b8" stroke-dasharray="4,2"/><text x="460" y="225" text-anchor="middle" fill="#e2e8f0" font-size="9">Returns unsanitized comment</text>
<rect x="460" y="250" width="150" height="25" rx="4" fill="#ef4444"/><text x="535" y="267" text-anchor="middle" fill="white" font-size="10">&lt;script&gt; executes!</text>
</svg>
</div>
...
<text x="220" y="14" text-anchor="middle" fill="#dc2626" font-size="11" font-weight="bold">Escenario de Ataque Real — Cookie Stealing</text>
<rect x="10" y="24" width="420" height="20" rx="4" fill="#ef4444"/><text x="220" y="38" text-anchor="middle" fill="white" font-size="8">1. Attacker inyecta payload → 2. Admin visita feedback → 3. Cookie enviada a attacker</text>
<line x1="220" y1="44" x2="220" y2="56" stroke="#94a3b8" stroke-width="1.5"/>
<rect x="10" y="58" width="420" height="20" rx="4" fill="#8b5cf6"/><text x="220" y="72" text-anchor="middle" fill="white" font-size="8">4. Attacker impersona admin → 5. Acceso TOTAL al sistema</text>
<rect x="10" y="84" width="135" height="16" rx="4" fill="#1e293b"/><text x="77" y="96" text-anchor="middle" fill="#94a3b8" font-size="7">Tiempo: segundos</text>
<rect x="155" y="84" width="135" height="16" rx="4" fill="#1e293b"/><text x="222" y="96" text-anchor="middle" fill="#94a3b8" font-size="7">Detección: difícil</text>
<rect x="300" y="84" width="130" height="16" rx="4" fill="#1e293b"/><text x="365" y="96" text-anchor="middle" fill="#fca5a5" font-size="7">Impacto: crítico</text>
</svg>
</div>
...
- CWE-347: Insufficient Verification of Data Authenticity. <https://cwe.mitre.org/data/definitions/345.html>
