...
![OWASP Juice Shop - Página principal mostrando el catálogo de productos con navbar superior](images/juice-shop/juice-shop-homepage.png){width=80%}
...
![Score Board de Juice Shop mostrando challenges completados y pendientes](images/juice-shop/score-board.png){width=80%}
...
![Burp Suite mostrando la petición POST al endpoint /rest/user/login con el payload SQLi en el body](images/juice-shop/burp-sqli-login.png){width=80%}
...
![Burp Suite Repeater mostrando la petición modificada con el payload SQLi y la respuesta con el token JWT del admin](images/juice-shop/burp-repeater-sqli.png){width=80%}
...
![Firefox DevTools Console mostrando el payload XSS ejecutándose con un alert(1) disparado por onerror](images/juice-shop/dom-xss-alert.png){width=80%}
...
![Burp Suite mostrando la interceptación de la petición GET con el parámetro q conteniendo el payload XSS](images/juice-shop/burp-dom-xss.png){width=80%}
...
![Navegador mostrando la página de resultados de búsqueda con el payload XSS reflejado ejecutándose](images/juice-shop/reflected-xss-execution.png){width=80%}
...
![jwt.io mostrando un token JWT decodificado con header, payload y signature visibles](images/juice-shop/jwt-decoded.png){width=80%}
...
![Terminal mostrando el script Python ejecutándose y devolviendo datos del usuario admin con el token manipulado](images/juice-shop/jwt-alg-none-exploit.png){width=80%}
...
![Burp Suite mostrando múltiples peticiones GET a /rest/basket/1, /rest/basket/2, /rest/basket/3 con respuestas exitosas](images/juice-shop/basket-idor-burp.png){width=80%}
...
![Navegador mostrando el contenido de un archivo del sistema accedido mediante directory traversal](images/juice-shop/directory-traversal-result.png){width=80%}
...
![Burp Suite mostrando la petición POST al endpoint /api/Feedback con el payload XSS stored en el body JSON](images/juice-shop/burp-stored-xss.png){width=80%}
